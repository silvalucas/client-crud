package br.com.testetecnico.cliente.controller;

import br.com.testetecnico.cliente.entity.Cliente;
import br.com.testetecnico.cliente.service.ClienteService;
...
public class ClienteController {
    ...
    public Cliente buscarClientePorId(@PathVariable("id") Long id){
        return clienteService.buscarPorId(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Cliente nao encontrado"));
    }
